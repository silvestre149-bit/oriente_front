...
function ColunaProfessores(props){
    return <>
    {props.professores.map((professor,index)=> <div key={index}><p>{professor.nome} <br/> ({professor.categoria}) - {professor.status} </p> <br /> </div>)}
    </>
}
...
export const COLUNAS_AVALIACAO = [
    ...
    {
        Header: 'Professores',
        Cell: props => <ColunaProfessores professores={props.row.original.professores}/>
    },
    {
        Header: 'Situação',
        accessor: 'situacao',
...
export const DADOS = [
    {
        ...
        professores: [
            {
                nome: "Professor 1",
                id: "Id do professor 1",
                status: "pendente",// "aceito" || "pendente" || "recusado"
                categoria: "Orientador",// Orientador || Coorientador || Avaliador
            }
        ],
